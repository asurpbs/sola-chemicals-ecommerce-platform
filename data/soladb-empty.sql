...
DROP DATABASE IF EXISTS `hashcoders_solachem`;
CREATE DATABASE IF NOT EXISTS `hashcoders_solachem` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
CREATE TABLE IF NOT EXISTS `admin` (
  ...
  UNIQUE KEY `tele_number` (`tele_number`)
...
INSERT INTO `admin` (`id`, `first_name`, `last_name`, `image`, `gender`, `email`, `password`, `tele_number`, `role`, `registered_date`, `date_modified`, `last_visited`) VALUES
	(1, 'Mithila', 'Prabashwara', 'null.png', 'm', 'mithila@gmail.com', '$2y$10$IwdCX15BMVqv9A.fSkqGhOXjOdM9SUS81AlduejGjcUVTeTZX6nIi', '0777777777', 'Database Engineer', '2025-01-19 16:59:19', '2025-01-19 17:01:58', NULL),
	(2, 'Thakshila', 'Dilshan', 'null.png', 'm', 'thakshila@gmail.com', '$2y$10$OameerdV9q2GMyvnQXVJ/OzNZPpfmDXysHJrZxy2zd7Tb7argejsy', '0771111111', 'UI/ UX Engineer', '2025-01-19 17:01:06', '2025-01-19 17:01:36', NULL),
	(3, 'Tharushika', 'Dilshan', 'null.png', 'm', 'tharushika@gmail.com', '$2y$10$4u3MvjEL837Bex1TyOpOluZTkdP83w..iSQyVe7gz3fqTdpesW11e', '0772222222', 'Frontend Developer', '2025-01-19 17:01:55', '2025-01-19 17:03:06', NULL),
	(4, 'Chamal', 'Jayawardhana', 'null.png', 'm', 'chamal@gmail.com', '$2y$10$br/yWo7.xjRUFrAOOowB7uKgINmegfMb06GeszGQsTCl38MJB4XG', '0771212121', 'Business Analyst', '2025-01-19 17:04:01', '2025-01-19 17:04:24', NULL),
	(5, 'Chamod', 'Abethunga', 'null.png', 'm', 'chamod@gmail.com', '$2y$10$dvn0Snb.b.i6kbHvESFb4OO1HNH7UIBNcl8JWZaPSBrdqWUPSlj9a', '0711111111', 'Backend Developer', '2025-01-19 17:06:04', '2025-01-19 17:06:04', NULL);
...
CREATE TABLE IF NOT EXISTS `banner` (
  ...
  KEY `FK_banner_admin` (`admin_id`),
  CONSTRAINT `FK_banner_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `banner` (`admin_id`, `image`, `description`, `status`, `date_created`, `date_modified`, `date_published`) VALUES
	(1, '678f984269b89.webp', 'example banner 1', _binary 0x30, '2025-01-22 17:56:12', '2025-01-23 02:03:15', NULL),
	(2, '', 'example banner 2', _binary 0x30, '2025-01-22 17:56:30', '2025-01-22 17:56:30', NULL),
	(3, '', 'example banner 2', _binary 0x30, '2025-01-22 17:57:13', '2025-01-22 17:57:47', NULL),
	(4, '', 'example banner 4', _binary 0x30, '2025-01-22 17:58:03', '2025-01-22 17:58:03', NULL),
	(NULL, '', 'example banner 6', _binary 0x30, '2025-01-22 17:58:16', '2025-01-23 08:16:12', NULL),
	(1, '678f984269b89.webp', 'example banner 1', _binary 0x30, '2025-01-22 17:56:12', '2025-01-23 02:03:15', NULL),
	(2, '', 'example banner 2', _binary 0x30, '2025-01-22 17:56:30', '2025-01-22 17:56:30', NULL),
	(3, '', 'example banner 2', _binary 0x30, '2025-01-22 17:57:13', '2025-01-22 17:57:47', NULL),
	(4, '', 'example banner 4', _binary 0x30, '2025-01-22 17:58:03', '2025-01-22 17:58:03', NULL),
...
CREATE TABLE IF NOT EXISTS `branch` (
  ...
  CONSTRAINT `FK_branch_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_branch_city` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TABLE IF EXISTS `branch_telephone`;
CREATE TABLE IF NOT EXISTS `branch_telephone` (
  `branch_id` smallint(5) unsigned DEFAULT NULL,
  `number1` varchar(10) NOT NULL DEFAULT '',
  `number2` varchar(10) DEFAULT '',
  UNIQUE KEY `number1` (`number1`),
  KEY `FK__branch` (`branch_id`),
  CONSTRAINT `FK__branch` FOREIGN KEY (`branch_id`) REFERENCES `branch` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `cart_item` (
  ...
  KEY `FK_cart_items_item` (`item_id`),
  CONSTRAINT `FK_cart_items_cart` FOREIGN KEY (`cart_id`) REFERENCES `cart` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_cart_items_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `company_contact_info` (
  ...
  `date_created` timestamp NOT NULL DEFAULT current_timestamp(),
  `date_modified` timestamp NOT NULL DEFAULT current_timestamp(),
  KEY `FK_company_contact_info_admin` (`admin_id`),
  CONSTRAINT `FK_company_contact_info_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `company_contact_info` (`admin_id`, `address1`, `address2`, `city`, `email`, `facebook_url`, `instagram`, `daraz`, `whatsapp`, `youtube`, `tele_number1`, `tele_number2`, `date_created`, `date_modified`) VALUES
...
CREATE TABLE IF NOT EXISTS `district` (
  ...
  CONSTRAINT `fk_districts_provinces1` FOREIGN KEY (`province_id`) REFERENCES `province` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `faq` (
  ...
  `date_modified` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`),
  KEY `FK_faq_admin` (`admin_id`),
  CONSTRAINT `FK_faq_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS `feedback` (
  ...
  CONSTRAINT `FK_feedback_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `feedback` (`id`, `user_id`, `comment`, `status`, `date_created`) VALUES
	(1, 1, 'Great product! It worked exactly as described and arrived on time', _binary 0x30, '2025-01-21 14:29:38'),
	(2, 2, 'Amazing quality! Definitely will buy again.', _binary 0x30, '2025-01-21 14:29:55'),
	(3, 4, 'Amazing experience from start to finish. Thank you!', _binary 0x30, '2025-01-21 14:30:13'),
	(4, 2, 'Happy with my purchase! ItÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s exactly what I needed.', _binary 0x30, '2025-01-21 14:30:36'),
	(5, 4, 'Excellent product. It exceeded my expectations!', _binary 0x30, '2025-01-21 14:30:53');
...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  KEY `FK_item_order_method` (`delivery_method_id`),
  CONSTRAINT `FK_item_category` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_item_order_method` FOREIGN KEY (`delivery_method_id`) REFERENCES `delivery_method` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `item` (`id`, `name`, `image`, `category_id`, `QoH`, `UP`, `discount_rate`, `availability`, `delivery_method_id`, `views`, `date_created`, `date_modified`) VALUES
	(1, 'Orange Hand Wash 4L', '', 2, 2, 1600.00, NULL, _binary 0x31, NULL, 0, '2025-01-21 14:46:38', '2025-01-22 17:51:57'),
	(2, 'Mango Hand Wash', '', 2, 9, 1600.00, NULL, _binary 0x31, NULL, 0, '2025-01-21 14:47:55', '2025-01-22 16:55:10'),
	(3, 'Confident Hand Sanitizer', '', 2, 23, 3600.00, NULL, _binary 0x31, NULL, 0, '2025-01-21 14:56:04', '2025-01-22 16:56:00'),
	(4, 'Uphostery Carpet Cleaner 4L', '', 1, 0, 1600.00, NULL, _binary 0x30, NULL, 0, '2025-01-21 14:56:30', '2025-01-21 14:57:20'),
	(5, 'Carwash Shampoo', '', 1, 1, 980.00, NULL, _binary 0x31, NULL, 0, '2025-01-21 14:57:59', '2025-01-22 16:55:25');
...
CREATE TABLE IF NOT EXISTS `news_and_events` (
  ...
  `date_published` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_news_&_events_admin` (`admin_id`),
  CONSTRAINT `FK_news_&_events_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `news_and_events` (`id`, `image`, `admin_id`, `article_title`, `content`, `likes`, `dislikes`, `views`, `status`, `date_created`, `daet_modified`, `date_published`) VALUES
	(7, 'Yj3Kd9f7XqL5.jpg', 1, 'Benefits of Eco-Friendly Detergents', 'Learn why eco-friendly detergents are better for the environment and your health.', _binary 0x30, _binary 0x30, 0, _binary 0x30, '2025-01-23 13:20:35', '2025-01-23 13:20:35', NULL),
	(8, 'Hk9Lt3Xb7MnP.jpg', 2, 'The Science Behind Soaps', 'Explore how soaps work to remove grease and grime effectively.', _binary 0x30, _binary 0x30, 0, _binary 0x30, '2025-01-23 13:20:35', '2025-01-23 13:20:35', NULL),
	(9, 'Qw4Nr8Vg3XpK.jpg', 3, 'Choosing the Right Cleaning Products', 'Understand the differences between soaps, detergents, and disinfectants.', _binary 0x30, _binary 0x30, 0, _binary 0x30, '2025-01-23 13:20:35', '2025-01-23 13:20:35', NULL),
	(10, 'Ax3Lq9Tn6RpJ.jpg', 4, 'Top Detergents for Sensitive Skin', 'A review of detergents specially formulated for sensitive skin types.', _binary 0x30, _binary 0x30, 0, _binary 0x30, '2025-01-23 13:20:35', '2025-01-23 13:20:35', NULL),
	(11, 'Zp8Kv3Wr6XlN.jpg', 5, 'How Detergents Impact the Environment', 'A deep dive into the environmental effects of detergent usage.', _binary 0x30, _binary 0x30, 0, _binary 0x30, '2025-01-23 13:20:35', '2025-01-23 13:20:35', NULL),
	(12, 'Gr9Lp7Wn3XkQ.jpg', 2, 'Innovations in Soap Manufacturing', 'Discover the latest trends and innovations in soap production.', _binary 0x30, _binary 0x30, 0, _binary 0x30, '2025-01-23 13:20:35', '2025-01-23 13:20:35', NULL);
...
CREATE TABLE IF NOT EXISTS `notification` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_notification_admin` (`admin_id`),
  KEY `FK_notification_order` (`order_id`),
  KEY `FK_notification_public_contact` (`public_contact_id`),
  CONSTRAINT `FK_notification_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_notification_order` FOREIGN KEY (`order_id`) REFERENCES `order` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_notification_public_contact` FOREIGN KEY (`public_contact_id`) REFERENCES `public_contact` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `notification` (`id`, `admin_id`, `order_id`, `public_contact_id`, `message`, `status`, `date_created`, `accessed_date`) VALUES
	(1, NULL, 1, NULL, 'New order is placed.', _binary 0x30, '2025-01-22 18:28:20', NULL),
	(2, 4, 4, NULL, 'New order is placed', _binary 0x31, '2025-01-22 18:29:44', NULL),
	(3, NULL, NULL, 1, 'New feedback is added', _binary 0x30, '2025-01-22 18:31:12', NULL),
	(4, 1, 1, NULL, 'New order is placed.', _binary 0x30, '2025-01-22 18:31:50', NULL),
	(5, 5, 1, NULL, 'New order is placed.', _binary 0x30, '2025-01-22 18:42:07', NULL);
...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  KEY `FK_order_delivery_method` (`delivery_method_id`),
  CONSTRAINT `FK_order_delivery_method` FOREIGN KEY (`delivery_method_id`) REFERENCES `delivery_method` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_order_item` FOREIGN KEY (`item_id`) REFERENCES `item` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `order` (`id`, `item_id`, `user_id`, `quantity`, `delivery_method_id`, `status`, `total`, `delivered_date`, `description`, `date_created`, `date_modified`) VALUES
	(1, 5, 1, 12, 2, _binary 0x30, 0.00, NULL, NULL, '2025-01-21 15:27:48', '2025-01-21 15:27:48'),
	(4, 1, 4, 5, 1, _binary 0x30, 0.00, NULL, NULL, '2025-01-21 16:43:20', '2025-01-21 16:43:20'),
	(5, 2, 4, 1, 5, _binary 0x30, 0.00, NULL, NULL, '2025-01-21 18:00:35', '2025-01-21 18:00:35'),
	(6, 3, 1, 20, 4, _binary 0x30, 0.00, NULL, NULL, '2025-01-22 16:56:00', '2025-01-22 16:56:00'),
	(7, 1, 3, 5, 1, _binary 0x30, 0.00, NULL, NULL, '2025-01-22 17:51:57', '2025-01-22 17:51:57');
...
DROP TABLE IF EXISTS `public_contact`;
...
INSERT INTO `public_contact` (`id`, `name`, `email`, `message`, `date_created`, `status`) VALUES
	(1, 'Renuka Shehan', 'renukashehan@gmail.com', 'Hi!', '2025-01-21 13:51:55', _binary 0x30),
	(2, 'Sasidu Gamage', 'sasaidu@nest.club', 'Hello!', '2025-01-21 13:52:28', _binary 0x30),
	(3, 'Renuka Shehan', 'renuka@gmail.com', 'Plz reply', '2025-01-21 13:53:03', _binary 0x30),
	(4, 'Kalana Tharusha', 'kalana@gmail.com', 'Best service!', '2025-01-21 13:54:01', _binary 0x30),
	(5, 'Pwan Madusanka', 'pawan@gmail.com', 'HeyÃƒÂ°Ã…Â¸Ã‹Å“Ã‚Â!', '2025-01-21 13:54:44', _binary 0x30),
	(6, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I WANT UNIT PRICES FOR FOLOWING ITEMS, BECAUSEI AM INTERESTED IN PURCHAING YOUR PRODUCTS AND PLEASE GIVE ME ANSWER WITH FOLOWING QUESTIONS,\r\n1.AIR FRESHENER 4LITRES CAN\'S UNIT PRICE?\r\n2.ALL PURPOSE  4LITRES CAN\'S UNIT PRICE?\r\n3.TOILET BOWL CLEANER 4LITRES CAN\'S UNIT PRICE?\r\n4.PYNOL 4LITRES CAN\'S UNIT PRICE?\r\n5. AIR FRESHENER TABLET\'S UNIT PRICE?\r\n  THANK YOU SO MUCH.', '2025-02-14 03:21:40', _binary 0x30),
	(7, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I WANT UNIT PRICES FOR FOLOWING ITEMS, BECAUSEI AM INTERESTED IN PURCHAING YOUR PRODUCTS AND PLEASE GIVE ME ANSWER WITH FOLOWING QUESTIONS,\r\n1.AIR FRESHENER 4LITRES CAN\'S UNIT PRICE?\r\n2.ALL PURPOSE  4LITRES CAN\'S UNIT PRICE?\r\n3.TOILET BOWL CLEANER 4LITRES CAN\'S UNIT PRICE?\r\n4.PYNOL 4LITRES CAN\'S UNIT PRICE?\r\n5. AIR FRESHENER TABLET\'S UNIT PRICE?\r\n  THANK YOU SO MUCH.', '2025-02-14 03:21:47', _binary 0x30),
	(8, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I WANT UNIT PRICES FOR FOLOWING ITEMS, BECAUSEI AM INTERESTED IN PURCHAING YOUR PRODUCTS AND PLEASE GIVE ME ANSWER WITH FOLOWING QUESTIONS,\r\n1.AIR FRESHENER 4LITRES CAN\'S UNIT PRICE?\r\n2.ALL PURPOSE  4LITRES CAN\'S UNIT PRICE?\r\n3.TOILET BOWL CLEANER 4LITRES CAN\'S UNIT PRICE?\r\n4.PYNOL 4LITRES CAN\'S UNIT PRICE?\r\n5. AIR FRESHENER TABLET\'S UNIT PRICE?\r\n  THANK YOU SO MUCH.', '2025-02-14 03:21:59', _binary 0x30),
	(9, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I WANT UNIT PRICES FOR FOLOWING ITEMS, BECAUSEI AM INTERESTED IN PURCHAING YOUR PRODUCTS AND PLEASE GIVE ME ANSWER WITH FOLOWING QUESTIONS,\r\n1.AIR FRESHENER 4LITRES CAN\'S UNIT PRICE?\r\n2.ALL PURPOSE  4LITRES CAN\'S UNIT PRICE?\r\n3.TOILET BOWL CLEANER 4LITRES CAN\'S UNIT PRICE?\r\n4.PYNOL 4LITRES CAN\'S UNIT PRICE?\r\n5. AIR FRESHENER TABLET\'S UNIT PRICE?\r\n  THANK YOU SO MUCH.', '2025-02-14 03:22:00', _binary 0x30),
	(10, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I am interested in purchasing your products,\r\n    Because I\'m to buy your products.\r\nThat\'s why we need to know the prices of the products we want to buy.\r\nPlease be with him.\r\nhow many rupees all-purpose 4litres can\'s unit?\r\n how many rupees toilet bowel cleaner 4litres can\'s unit?\r\nhow many rupees phenol 4litres can\'s unit?\r\nhow many rupees air freshener 4litres can\'s unit?\r\nhow many rupees glass cleaner 4litres can\'s unit?\r\n   \'m looking forward to your answers to the above questions.', '2025-02-14 03:55:05', _binary 0x30),
	(11, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I am interested in purchasing your products,\r\n    Because I\'m to buy your products.\r\nThat\'s why we need to know the prices of the products we want to buy.\r\nPlease be with him.\r\nhow many rupees all-purpose 4litres can\'s unit?\r\n how many rupees toilet bowel cleaner 4litres can\'s unit?\r\nhow many rupees phenol 4litres can\'s unit?\r\nhow many rupees air freshener 4litres can\'s unit?\r\nhow many rupees glass cleaner 4litres can\'s unit?\r\n   \'m looking forward to your answers to the above questions.', '2025-02-14 03:55:11', _binary 0x30),
	(12, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I am interested in purchasing your products,\r\n    Because I\'m to buy your products.\r\nThat\'s why we need to know the prices of the products we want to buy.\r\nPlease be with him.\r\nhow many rupees all-purpose 4litres can\'s unit?\r\n how many rupees toilet bowel cleaner 4litres can\'s unit?\r\nhow many rupees phenol 4litres can\'s unit?\r\nhow many rupees air freshener 4litres can\'s unit?\r\nhow many rupees glass cleaner 4litres can\'s unit?\r\n   \'m looking forward to your answers to the above questions.', '2025-02-14 03:55:12', _binary 0x30),
	(13, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I am interested in purchasing your products,\r\n    Because I\'m to buy your products.\r\nThat\'s why we need to know the prices of the products we want to buy.\r\nPlease be with him.\r\nhow many rupees all-purpose 4litres can\'s unit?\r\n how many rupees toilet bowel cleaner 4litres can\'s unit?\r\nhow many rupees phenol 4litres can\'s unit?\r\nhow many rupees air freshener 4litres can\'s unit?\r\nhow many rupees glass cleaner 4litres can\'s unit?\r\n   \'m looking forward to your answers to the above questions.', '2025-02-14 03:55:13', _binary 0x30),
	(14, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I am interested in purchasing your products,\r\n    Because I\'m to buy your products.\r\nThat\'s why we need to know the prices of the products we want to buy.\r\nPlease be with him.\r\nhow many rupees all-purpose 4litres can\'s unit?\r\n how many rupees toilet bowel cleaner 4litres can\'s unit?\r\nhow many rupees phenol 4litres can\'s unit?\r\nhow many rupees air freshener 4litres can\'s unit?\r\nhow many rupees glass cleaner 4litres can\'s unit?\r\n   I\'m looking forward to your answers to the above questions.', '2025-02-14 03:55:30', _binary 0x30),
	(15, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I am interested in purchasing your products,\r\n    Because I\'m to buy your products.\r\nThat\'s why we need to know the prices of the products we want to buy.\r\nPlease be with him.\r\nhow many rupees all-purpose 4litres can\'s unit?\r\n how many rupees toilet bowel cleaner 4litres can\'s unit?\r\nhow many rupees phenol 4litres can\'s unit?\r\nhow many rupees air freshener 4litres can\'s unit?\r\nhow many rupees glass cleaner 4litres can\'s unit?\r\n   I\'m looking forward to your answers to the above questions.', '2025-02-14 04:05:58', _binary 0x30),
	(16, 'SAMEERA THUSHAN FONSEKA', 'sameerathushan180@gmail.com', 'I am interested in purchasing your products,\r\n    Because I\'m to buy your products.\r\nThat\'s why we need to know the prices of the products we want to buy.\r\nPlease be with him.\r\nhow many rupees all-purpose 4litres can\'s unit?\r\n how many rupees toilet bowel cleaner 4litres can\'s unit?\r\nhow many rupees phenol 4litres can\'s unit?\r\nhow many rupees air freshener 4litres can\'s unit?\r\nhow many rupees glass cleaner 4litres can\'s unit?\r\n   I\'m looking forward to your answers to the above questions.', '2025-02-14 04:06:00', _binary 0x30),
	(17, 'Mithila Prabashwara', 'sdssds@fdgd.comdfsd', 'sdsd dsdsd sdsdasdsds dsdsdsdsdsdsd dsds', '2025-03-07 05:42:49', _binary 0x30);
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `image`, `gender`, `birth_date`, `password`, `email`, `registered_date`, `date_modified`, `last_visited`) VALUES
	(1, 'Mithila', 'Prabashwara', 'null.png', 'm', '2001-10-07', '$2y$10$esz4viBudShpLzERyDjqLu/ZL/pRa0pWxtkIxAdxxpnMjwY6DY1Jm', 'mithila@135', '2025-01-19 17:09:30', '2025-01-19 17:09:30', '2025-02-12 09:33:34'),
	(2, 'Chathun', 'Mihiranga', 'null.png', 'm', '2002-01-19', '$2y$10$cKiG/kGumcaqQa0DThsdx.Sm3WsIiJ3NC/vFLJGcVYectAcczVa5u', 'mihiranga@gmail.com', '2025-01-19 17:10:33', '2025-01-19 17:11:22', '2025-02-01 10:38:59'),
	(3, 'Chamal', 'Jayasuria', 'null.png', 'm', '2002-01-19', '$2y$10$yBAyoUhMR9QMV.0Ri3owq.v2lnyHKb9/lzwkfo.g9zHhzvj8juFva', 'chamal@gmail.com', '2025-01-19 17:11:03', '2025-01-19 17:11:32', '2025-03-13 20:02:04'),
	(4, 'Chamod', 'Abethunga', 'null.png', 'm', '1999-02-19', '$2y$10$HmImc1fzOJbsfQCzAs3BGuhsUXhUm3YjoEAFOvo9oJojNmfdPOkKK', 'chamod@gmail.com', '2025-01-19 17:12:58', '2025-01-19 17:12:58', '2025-03-13 15:18:50'),
	(5, 'Tharushika', 'Dilshan', 'null.png', 'm', '2001-04-01', '$2y$10$qmlsxB8uFEVhL5XgQ/XM4uHqRN2GIYzzeDjn1qeePzaETQx.WWf3u', 'tharukshila@gmail.com', '2025-01-19 17:14:22', '2025-01-19 17:15:55', '2025-01-26 20:50:21'),
	(6, 'Thakshila', 'Dilshan', 'null.png', 'm', '0000-00-00', '$2y$10$f55q/.CEMfn6YCts7nEF5.hzzrupLzM2c.EuKeqBRcbaQhpcKmJeC', 'thakshila@135', '2025-01-19 17:15:32', '2025-01-19 17:15:32', '2025-01-26 20:50:21');
...
INSERT INTO `user_address` (`user_id`, `address1`, `address2`, `postal_code`, `city_id`) VALUES
	(5, 'No: 195/2', 'Akkara 7, 41 Halpe', '11200', 539),
...
CREATE TABLE IF NOT EXISTS `user_telephone` (
  ...
  KEY `FK_user_telephone_user` (`user_id`),
  CONSTRAINT `FK_user_telephone_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
DROP TRIGGER IF EXISTS `cart_items_before_insert validity check`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`379643_devs`@`%` TRIGGER `cart_items_before_insert validity check` BEFORE INSERT ON `cart_item` FOR EACH ROW BEGIN
...
DROP TRIGGER IF EXISTS `item_before_update update availability of items`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`379643_devs`@`%` TRIGGER `item_before_update update availability of items` BEFORE UPDATE ON `item` FOR EACH ROW BEGIN
    IF NEW.QoH < 0 THEN
        SIGNAL SQLSTATE '45000'
...
DROP TRIGGER IF EXISTS `news_and_events_before_insert`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`379643_devs`@`%` TRIGGER `news_and_events_before_insert` BEFORE INSERT ON `news_and_events` FOR EACH ROW BEGIN
...
DROP TRIGGER IF EXISTS `notification_before_insert updated update last accessed`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`379643_devs`@`%` TRIGGER `notification_before_insert updated update last accessed` BEFORE INSERT ON `notification` FOR EACH ROW BEGIN
IF NEW.status = 1 THEN
...
DROP TRIGGER IF EXISTS `order_after_insert update item stock`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`379643_devs`@`%` TRIGGER `order_after_insert update item stock` AFTER INSERT ON `order` FOR EACH ROW BEGIN
...
DROP TRIGGER IF EXISTS `order_before_insert avalidity check`;
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE DEFINER=`379643_devs`@`%` TRIGGER `order_before_insert avalidity check` BEFORE INSERT ON `order` FOR EACH ROW BEGIN
